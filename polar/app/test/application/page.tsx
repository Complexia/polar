                    ...
                    <div className="carousel rounded-box">
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="badge badge-secondary">0.2 ETH</div>
                        ...
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">Shoes!</h2>
                                    <div className="badge badge-secondary">0.3 ETH</div>
                                    <p>If a dog chews shoes whose shoes does he choose?</p>
                                    <div className="card-actions justify-end">
                                        <TxnButton />
                                    </div>
                        ...
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    <h2 className="card-title">Shoes!</h2>
                                    <div className="badge badge-secondary">0.1 ETH</div>
                                    <p>If a dog chews shoes whose shoes does he choose?</p>
                                    <div className="card-actions justify-end">
                                        <TxnButton />
                                    </div>
                        ...
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                <figure><img src="https://daisyui.com/images/stock/photo-1494253109108-2e30c049369b.jpg" alt="Shoes" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Shoes!</h2>
                                    <div className="badge badge-secondary">0.2 ETH</div>
                                    <p>If a dog chews shoes whose shoes does he choose?</p>
                        ...
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                <figure><img src="https://daisyui.com/images/stock/photo-1550258987-190a2d41a8ba.jpg" alt="Shoes" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Shoes!</h2>
                                    <div className="badge badge-secondary">0.3 ETH</div>
                                    <p>If a dog chews shoes whose shoes does he choose?</p>
                        ...
                        <div className="carousel-item">
                            <div className="card w-96 bg-base-100 shadow-xl">
                                <figure><img src="https://daisyui.com/images/stock/photo-1559181567-c3190ca9959b.jpg" alt="Shoes" /></figure>
                                <div className="card-body">
                                    <h2 className="card-title">Shoes!</h2>
                                    <div className="badge badge-secondary">0.2 ETH</div>
                                    <p>If a dog chews shoes whose shoes does he choose?</p>
